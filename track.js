...
function render(data){
  ...
  $("trackMain").innerHTML=`<article class="track-card ${showGateOutQr?"has-gateout-qr":""}">
    ...
    ${showGateOutQr?`<section class="track-gateout-qr"><div class="gateout-qr-copy"><small>พร้อมออกจากคลัง</small><b>ใช้สแกนเพื่อบันทึกเวลาออกจากคลัง</b></div><div class="gateout-qr-code">${qrSvg}</div><div class="gateout-autoid"><small>Auto ID</small><strong>${esc(autoId)}</strong></div></section>`:""}
