...
const FRONTEND_BUILD="2026.08.29-round207.38-alert-one-shot-readiness";
...
async function init() {
  ...
  if ("serviceWorker" in navigator) navigator.serviceWorker.register("./sw.js?v=20260829-r20738",{updateViaCache:"none"}).catch(() => undefined);
