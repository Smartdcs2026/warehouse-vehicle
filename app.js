...
function openPublicQueue(){window.open(new URL("./queue.html?v=20260810-r83.6",location.href).href,"_blank","noopener")}
...
function renderAdminQueue(){
  const panel=$("adminPanel");if(!panel)return;
  const queueUrl=new URL("./queue.html?v=20260810-r83.6",location.href).href;
  panel.innerHTML=`<div class="admin-section-head clean-admin-head"><div><h3>จอแสดงสถานะคิว</h3><p>ใช้สำหรับจอส่วนกลาง ต้องเข้าสู่ระบบด้วยบัญชีผู้ดูแลระบบหรือผู้ใช้งาน</p></div><a class="primary admin-queue-open" href="./queue.html?v=20260810-r83.6" target="_blank" rel="noopener">เปิดจอคิว</a></div>
