...
const FRONTEND_BUILD="2026.08.29-round207.39-readiness-item-details";
...
async function init() {
  ...
  if ("serviceWorker" in navigator) navigator.serviceWorker.register("./sw.js?v=20260829-r20739",{updateViaCache:"none"}).catch(() => undefined);
