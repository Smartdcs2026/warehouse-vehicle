...
const FRONTEND_BUILD="2026.08.29-round207.36-dynamic-release-name";
...
async function init() {
  ...
  if ("serviceWorker" in navigator) navigator.serviceWorker.register("./sw.js?v=20260829-r20736",{updateViaCache:"none"}).catch(() => undefined);
