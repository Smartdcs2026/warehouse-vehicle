...
function showInboundTracking(tracking,vehicle,seconds){
  ...
  body.innerHTML=`<div class="driver-qr-code">${qr}</div><div class="driver-qr-caption"><div class="driver-qr-meta"><span><small>หมายเลขนัดหมาย</small><b>${escapeHtml(appointment)}</b></span><span><small>บริษัท</small><strong>${escapeHtml(company)}</strong></span><span><small>ทะเบียนรถ</small><strong>${escapeHtml(plate)}</strong></span></div><p>เปิดกล้องโทรศัพท์แล้วสแกน QR ด้านบน</p></div>`;
