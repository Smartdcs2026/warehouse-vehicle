...
const FRONTEND_BUILD="2026.08.27-round207.30-inbound-mobile-sections";
...
async function init() {
  ...
  if ("serviceWorker" in navigator) navigator.serviceWorker.register("./sw.js?v=20260827-r20730",{updateViaCache:"none"}).catch(() => undefined);
