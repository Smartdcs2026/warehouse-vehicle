...
const FRONTEND_BUILD="2026.08.18-round181-live-enrichment-wiring-default-off";
...
async function init() {
  ...
  if ("serviceWorker" in navigator) navigator.serviceWorker.register("./sw.js?v=20260818-r181",{updateViaCache:"none"}).catch(() => undefined);
