...
const FRONTEND_BUILD="2026.08.20-round204.1-appointment-timing-policy";
...
const adminDataTools={tab:"overview",source:"main",inspectorBySource:{},busy:false,openTable:"",openCommand:"",openSchema:"",retention:null,retentionBusy:false,archiveMonth:"",archivePreview:null,archiveBusy:false,archiveHistory:null,archiveHistoryBusy:false,archiveStoreBusy:false,archiveVerify:null,archiveVerifyBusy:false,cleanupMonth:"",cleanupPreview:null,cleanupBusy:false,cleanupScript:null,cleanupVerify:null,cleanupExecuteBusy:false,cleanupHistory:null};
...
async function renderAdminDataUsage(){
  ...
  try{
    ...
    $("refreshDataUsage")?.addEventListener("click",()=>{adminDataTools.inspectorBySource={};adminDataTools.retention=null;renderAdminDataUsage()});
