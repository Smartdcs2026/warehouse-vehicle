...
const FRONTEND_BUILD="2026.08.29-round207.35-dashboard-mobile-order";
...
async function init() {
  ...
  if ("serviceWorker" in navigator) navigator.serviceWorker.register("./sw.js?v=20260829-r20735",{updateViaCache:"none"}).catch(() => undefined);
