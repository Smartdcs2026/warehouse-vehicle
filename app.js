...
const FRONTEND_BUILD="2026.08.25-round207.25-final-approval";
...
function clearSession() { stopCamera();cancelDashboardRequest();dashboardState.data=null;dashboardState.dataIdentity="";dashboardState.error="";dashboardState.analyticsError="";dashboardState.analyticsLastLoadedAt=0;dashboardState.lastLoadedAt=0;dashboardState.snapshotLoaded=false;clearDashboardStaleRecovery(true); inboundLiveState.version="";inboundLiveState.checking=false;inboundLiveState.failures=0;inboundLiveState.nextAllowedAt=0;alertSoundState.initialized=false;alertSoundState.levels.clear();clearStoredAuthToken(); sessionStorage.removeItem("wvf_dashboard_snapshot_r118"); state.token=""; state.user=null; state.display={dashboardEnabled:true,datatableEnabled:true}; state.appointment={moduleEnabled:false,uploadEnabled:false}; appointmentStopWorker(); appointmentUploadState.config=null;appointmentUploadState.result=null;appointmentUploadState.preview=null;appointmentUploadState.mappingNeeded=null;try{appointmentAdminFileProbe.worker?.terminate()}catch{}appointmentAdminFileProbe.worker=null;appointmentAdminFileProbe.result=null;appointmentAdminFileProbe.fileName=""; if($("mobileAccountName"))$("mobileAccountName").textContent="-"; $("appView").hidden=true; $("loginView").hidden=false; $("loginPassword").value=""; window.scrollTo(0, 0); }
