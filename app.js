...
function renderDatatableLayout(){
  ...
  renderDatatableSide();syncDatatableShiftHint();renderDatatableBusinessDateNote();bindDatatableEvents();updateFullscreenButton();toggleDatatableMobileFilters(window.innerWidth>760?true:datatableState.mobileFiltersOpen);
}
...
function renderDatatableSummary(summary){
  ...
  if(mobileToggle)mobileToggle.textContent=`ตัวกรอง · ${total.toLocaleString("th-TH")} รายการ`;
}
