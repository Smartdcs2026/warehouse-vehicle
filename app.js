...
const FRONTEND_BUILD="2026.08.27-round207.31-inbound-mobile-density";
...
async function init() {
  ...
  if ("serviceWorker" in navigator) navigator.serviceWorker.register("./sw.js?v=20260827-r20731",{updateViaCache:"none"}).catch(() => undefined);
