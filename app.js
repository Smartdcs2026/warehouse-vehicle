...
const FRONTEND_BUILD="2026.08.18-round184-performance-resilience-concurrency";
...
function renderAdminAppointmentData(){
  ...
  $("appointmentLiveWiringUatButton")?.addEventListener("click",appointmentRunLiveWiringUat);$("appointmentDisplayUatButton")?.addEventListener("click",appointmentRunDisplayUat);$("appointmentKpiUatButton")?.addEventListener("click",appointmentRunKpiUat);$("appointmentStressUatButton")?.addEventListener("click",appointmentRunStressUat);
