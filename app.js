...
const FRONTEND_BUILD="2026.08.18-round182-operational-display-integration";
...
function renderAdminAppointmentData(){
  ...
  $("appointmentLiveWiringUatButton")?.addEventListener("click",appointmentRunLiveWiringUat);$("appointmentDisplayUatButton")?.addEventListener("click",appointmentRunDisplayUat);
