...
const FRONTEND_BUILD="2026.08.17-round164-sync-watchdog-resilience";
...
function apiDefaultTimeout(path,method){if(/archive|export|cleanup/i.test(String(path||"")))return 45000;if(/diagnostics\/(performance|resilience)/i.test(String(path||"")))return 20000;return method==="GET"?15000:20000}
